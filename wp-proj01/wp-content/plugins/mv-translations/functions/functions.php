...
function mvt_register_user() {
	...
	if ( ! isset( $user ) ) {
        ...
        <form action="" method="post" name="user_registeration">
            ...
            <input type="submit" name="user_registeration"
                   value="<?php echo esc_attr__( 'Sign Up', 'mv-translations' ); ?>"/>

            <input type="hidden" name="mv_translations_register_nonce"
                   value="<?php echo wp_create_nonce( 'mv_translations_register_nonce' ); ?>">
