    ...
    <tr>
        ...
        <td>
            <select name="mv_translations_transliteration" id="mv_translations_transliteration">
                <option value="Yes" <?php if ( isset( $results[0]['meta_value'] ) ) {
					selected( $results[0]['meta_value'], 'Yes' );
				} ?>><?php esc_html_e( 'Yes', 'mv-translations' ) ?></option>
                ';
                <option value="No" <?php if ( isset( $results[0]['meta_value'] ) ) {
					selected( $results[0]['meta_value'], 'No' );
